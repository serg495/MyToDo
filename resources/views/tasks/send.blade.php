            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        <input type="email" class="form-control" name="performer" placeholder="Performer E-mail" value="{{old('performer')}}">
                        @if ($errors->has('performer'))
                            <div class="alert alert-danger">{{ $errors->first('performer') }}</div>
                        @endif
                    </div>
                    <div class="form-group">
